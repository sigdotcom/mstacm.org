...
const PrevioustList: React.FC<IQueryProps> = ({
  loading,
  error,
  data,
}): JSX.Element => {
...
const ThisWeekList: React.FC<IQueryProps> = ({
  loading,
  error,
  data,
}): JSX.Element => {
...
const NextWeekList: React.FC<IQueryProps> = ({
  loading,
  error,
  data,
}): JSX.Element => {
...
const Future: React.FC<IQueryProps> = ({
  loading,
  error,
  data,
}): JSX.Element => {
